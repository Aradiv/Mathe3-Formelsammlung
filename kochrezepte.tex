...
%                \end{satz}
    ...
    %TODO add decision tree and maybe tests into table to compact them
        ...
        \end{enumerate}
        \subsection*{testen für $\mu$}
            \begin{enumerate}
                \stepcounter{enumi}
                \item a) $H_0: \mu = \mu_0$, b) $H_0: \mu \leq \mu_0$, c) $H_0: \mu \geq \mu_0$
            \end{enumerate}
        \subsubsection*{bei bekannter Varianz $\sigma^2 = \sigma_0^2$ \quad\Rightarrow\quad Gauß-Test}
            \begin{enumerate}
                \stepcounter{enumi}
                \stepcounter{enumi}
                \item Testgröße
            ...
            \end{enumerate}
        \subsubsection*{bei unbekannter Varianz $\sigma^2$ \quad\Rightarrow\quad t-Test}
            \begin{enumerate}
                \stepcounter{enumi}
                \stepcounter{enumi}
                \item Testgröße
            ...
            \end{enumerate}
        \subsection*{testen für $\sigma^2$ bei unbekanntem Erwartungswert $\mu$ \quad\Rightarrow\quad $\chi^2$-Streuungstest}
            \begin{enumerate}
                \stepcounter{enumi}
        ...
        \begin{center}
            {\makegapedcells\begin{tabular}{ l@{\hspace{0}}|c|c| }
                \multicolumn{1}{l}{1.} & \multicolumn{2}{l}{ $X_1,\dots,X_n$ unabhängig, identisch $N(\mu, \sigma^2)$-verteilt }\\
%                \hline
                \hline
                \multicolumn{3}{|l|}{testen für $\mu$}\\
                \hline
                \multicolumn{1}{l}{2.} & \multicolumn{2}{c}{ a) $H_0: \mu = \mu_0$ , b) $H_0: \mu \leq \mu_0$ , c) $H_0: \mu \geq \mu_0$ }\\
                \cline{2-3}
                &
                bei bekannter Varianz $\sigma^2 = \sigma_0^2$ \quad\Rightarrow\quad Gauß-Test
                &
                bei unbekannter Varianz $\sigma^2$ \quad\Rightarrow\quad t-Test\\
                \cline{2-3}
                \multicolumn{1}{l}{3.} &
                \multicolumn{2}{l}{ Testgröße $T(X_1,\dots,X_n)=$ }\\
                \cline{2-3}
                &
                ...
                \cline{2-3}
                \multicolumn{1}{l}{4.} &
                \multicolumn{2}{l}{ Ablehnung Falls }\\
                \cline{2-3}
                &
                a) $|T| > u_{1-\alpha/2}$, b) $T > u_{1-\alpha}$, c) $T < u_{\alpha}$
                &
                ...
                \noalign{\smallskip}
                \hline
                \multicolumn{3}{|l|}{ testen für $\sigma^2$ \qquad bei unbekanntem Erwartungswert $\mu$ \quad\Rightarrow\quad $\chi^2$-Streuungstest }\\
                \hline
